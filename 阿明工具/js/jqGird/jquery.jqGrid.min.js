            ...
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id))); else {
                        ...
                        b.xRuleSaveBtn && (
                            g += "<a id='" + h + "_save_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-lightbulb'></span>添加模板</a>" +
                                "<a id='" + h + "_del_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-lightbulb'></span>删除模板</a>"
                        );
                        ...
                        q = !1;
                        b.tmplNames && b.tmplNames.length && (q = !0, m = b.tmplLabel, m += "<select class='ui-template'>", m += "<option value='default'>默认</option>", a.each(b.tmplNames,
                            function (a, b) {
                        ...
                        a("body").on("click", "#" + h + "_reset", function () {
                            var c = {}, d = a("#" + h);
                            e.p.search = !1;
                            e.p.resetsearch = !0;
        ...
        groupingSetup: function () {
            ...
            return this.each(function () {
                ...
                d.each(f.groups, function (g, l) {
                    ...
                    r = q + "_" + g;
                    p = "<span style='cursor:pointer;' class='ui-icon " + n + "'></span>";
                    try {
